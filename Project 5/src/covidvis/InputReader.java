...
public class InputReader {
    ...
    private State[] readFile(String fileName) throws FileNotFoundException {
        ...
        while (file.hasNextLine()) {
            ...
            EthnicityGroup latin = new EthnicityGroup("Latinx", casesLat,
                cfrLat);
            EthnicityGroup asian = new EthnicityGroup("Asian", casesAsi,
                cfrAsi);
            EthnicityGroup other = new EthnicityGroup("Other", casesOth,
                cfrOth);
            SinglyLinkedList<EthnicityGroup> pop =
